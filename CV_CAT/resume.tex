...
\name{Mariona}{Masferrer i Fons}
\position{Professora | Editora}%{\enskip\cdotp\enskip}Security Expert}
%\address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+34) 697 53 96 21}
\email{masferrerifons@gmail.com}
%\homepage{www.posquit0.com}
\github{marionamasferrerifons}
\linkedin{marionamasferrerifons}
% \gitlab{gitlab-id}
